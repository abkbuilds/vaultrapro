...
export default defineTool({
  ...
  description:
    "Biggest recorded price gainers or losers across the Pokémon TCG catalogue over the last day, week, month or year, for English or Japanese cards.",
  inputSchema: {
    window: z
      .enum(["24h", "7d", "30d", "1y"])
      .describe("Movement window. Defaults to 7d.")
      .optional(),
