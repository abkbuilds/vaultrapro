...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Vaultra — TCG Scanner & Price Tracker" },
      {
        name: "description",
        content:
          "Scan Pokémon cards with AI, track TCGplayer, Cardmarket and eBay prices, and follow your collection's value.",
      },
      ...
      { property: "og:title", content: "Vaultra — TCG Scanner & Price Tracker" },
      {
        ...
        content:
          "AI card scanning, a full English + Japanese Pokémon database, and multi-source price graphs.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#12131c" },
    ],
    links: [
